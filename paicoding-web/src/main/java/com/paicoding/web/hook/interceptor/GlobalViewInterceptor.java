package com.paicoding.web.hook.interceptor;

import com.baomidou.mybatisplus.core.toolkit.ObjectUtils;
import com.paicoding.api.model.context.ReqInfoContext;
import com.paicoding.api.model.vo.ResVo;
import com.paicoding.api.model.vo.constants.StatusEnum;
import com.paicoding.core.permission.Permission;
import com.paicoding.core.permission.UserRole;
import com.paicoding.core.util.JsonUtil;
import com.paicoding.core.util.SpringUtil;
import com.paicoding.service.rank.service.UserActivityRankService;
import com.paicoding.service.rank.service.model.ActivityScoreBo;
            ...
            if (permission == null || permission.role() == UserRole.ALL) {
                if (ReqInfoContext.getReqInfo() != null) {
                    ...
                    SpringUtil.getBean(UserActivityRankService.class)
                            .addActivityScore(ReqInfoContext.getReqInfo().getUserId(),
